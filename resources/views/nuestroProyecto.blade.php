    ...
    <footer class="bg-black text-white py-12">
        <div class="container mx-auto flex flex-wrap justify-between">
            <div class="w-full md:w-1/3 p-4">
                <h3 class="font-bold">Informacion</h3>
                <p class="mt-4">Sistema digital que centraliza, procesa y difunde información crítica sobre desastres naturales para facilitar respuestas rápidas y coordinación efectiva.</p>
            ...
            <div class="w-full md:w-1/3 p-4">
                <h3 class="font-bold">Navegacion</h3>
                <ul class="mt-4 space-y-2">
                    <li><a class="hover:underline" href="1-vista-home.html">Home</a></li>
                    <li><a class="hover:underline" href="2-vista-nuestroProyecto.html">Nuestro proyecto</a></li>
                    <li><a class="hover:underline" href="4-vista-formulario.html">Reportes</a></li>
                    <li><a class="hover:underline" href="5-vista-INFO-entidad.html">Portafolio</a></li>
                    <li><a class="hover:underline"  href="http://www.proteccioncivil.gob.mx/work/models/ProteccionCivil/Resource/32/1/images/Formato3.pdf">Solicitud de recursos</a></li>
                    <li><a class="hover:underline" href="6-vista-equipo.html">Acerca de nosotros</a></li>
                </ul>
            </div>
            <div class="w-full md:w-1/3 p-4">
                <h3 class="font-bold">Contactanos</h3>
                <p class="mt-4">Informacion de contacto</p>
                <p class="mt-2">DESOFT@gmail.com</p>
