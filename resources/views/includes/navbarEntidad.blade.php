        ...
        <div class="container mx-auto flex justify-between items-center py-4">
            ...
            <div class="flex items-center">
                ...
                <nav id="menu" class="hidden md:flex space-x-4 ml-auto">
                    ...
                    <a class="nav-link hover:bg-white hover:bg-opacity-20 transition duration-300 px-4 py-2 rounded" href="2-vista-nuestroProyecto.html">BUZON DE REPORTES</a>
                    <a class="nav-link hover:bg-white hover:bg-opacity-20 transition duration-300 px-4 py-2 rounded" href="4-vista-formulario.html">PORTAFOLIO</a>
                    <a class="nav-link hover:bg-white hover:bg-opacity-20 transition duration-300 px-4 py-2 rounded" href="5-vista-INFO-entidad.html">MURO</a>
